...
1. **Recap section** - 2-4 bullet points summarizing infrastructure changes
...
- [done] Service added to docker-compose
- [done] Healthcheck configured
- [pending] Environment variables to set
...
2. **Continue** - Add more services
3. **Modify** - Change configuration
4. **See config** - Show docker-compose changes
...
- Clarifying infrastructure requirements
- Choosing between hosting options
- Gathering resource constraints
