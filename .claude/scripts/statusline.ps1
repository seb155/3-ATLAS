# Atlas Agent Framework - StatusLine & Utilities
# Author: Atlas Team | Version: 1.0.0

# ============================================================================
# TIMESTAMP UTILITIES - Unified format: YYYY-MM-DD HH:MM
# ============================================================================
function Get-AtlasTimestamp {
    return (Get-Date).ToString("yyyy-MM-dd HH:mm")
}

function Get-AtlasTimestampFull {
    return (Get-Date).ToString("yyyy-MM-dd HH:mm:ss")
}

function Get-AtlasDate {
    return (Get-Date).ToString("yyyy-MM-dd")
}

function Get-AtlasSessionId {
    return "session-" + (Get-Date).ToString("yyyyMMdd-HHmm")
}
