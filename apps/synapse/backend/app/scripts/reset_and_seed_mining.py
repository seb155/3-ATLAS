...
from app.models.auth import Client, Project, User, UserRole  # noqa: E402
from app.models.metamodel import MetamodelEdge, MetamodelNode  # noqa: E402
from app.models.rules import RuleExecution  # noqa: E402
...
def seed_mining_data(db):
    ...
    try:
        ...
        project1 = Project(
            ...
            client_id=client.id,
            description=(
                "Expansion project for the primary ore crushing facility "
                "in the Northern mining sector. Includes new conveyor systems, "
                "mill upgrades, and process automation."
            ),
            status="ACTIVE",
        )
        db.add(project1)
        ...
        project2 = Project(
            ...
            client_id=client.id,
            description=(
                "New tailings storage facility with advanced monitoring systems, "
                "environmental controls, and automated water treatment processes."
            ),
            status="ACTIVE",
        )
        db.add(project2)
