...
1. **Recap section** - 2-4 bullet points summarizing implementation
...
- [done] Endpoint created at /api/v1/resource
- [done] Model + schemas implemented
...
1. **Test** - Run pytest for this module
2. **Continue** - Next endpoint/feature
3. **Modify** - Change the implementation
4. **See code** - Show created files
...
- Clarifying data model requirements
- Choosing between API design patterns
- Gathering auth/permission requirements
